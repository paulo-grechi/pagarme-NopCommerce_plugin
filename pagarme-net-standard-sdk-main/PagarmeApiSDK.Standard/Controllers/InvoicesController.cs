...
namespace PagarmeApiSDK.Standard.Controllers
{
    ...
    /// InvoicesController.
    /// </summary>
    public class InvoicesController : BaseController, IInvoicesController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoicesController"/> class.
        /// </summary>
        public InvoicesController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
