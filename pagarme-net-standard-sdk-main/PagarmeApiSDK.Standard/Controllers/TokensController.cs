...
namespace PagarmeApiSDK.Standard.Controllers
{
    ...
    /// TokensController.
    /// </summary>
    public class TokensController : BaseController, ITokensController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokensController"/> class.
        /// </summary>
        public TokensController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
