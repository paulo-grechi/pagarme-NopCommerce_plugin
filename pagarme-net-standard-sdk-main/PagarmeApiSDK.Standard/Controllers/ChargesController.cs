...
namespace PagarmeApiSDK.Standard.Controllers
{
    ...
    /// ChargesController.
    /// </summary>
    public class ChargesController : BaseController, IChargesController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargesController"/> class.
        /// </summary>
        public ChargesController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
