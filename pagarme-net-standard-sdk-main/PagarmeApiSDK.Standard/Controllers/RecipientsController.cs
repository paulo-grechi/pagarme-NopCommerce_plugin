...
namespace PagarmeApiSDK.Standard.Controllers
{
    ...
    /// </summary>
    public class RecipientsController : BaseController, IRecipientsController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientsController"/> class.
        /// </summary>
        public RecipientsController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
