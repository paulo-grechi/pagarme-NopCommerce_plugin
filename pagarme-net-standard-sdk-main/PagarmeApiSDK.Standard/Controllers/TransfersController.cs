...
namespace PagarmeApiSDK.Standard.Controllers
{
    ...
    /// TransfersController.
    /// </summary>
    public class TransfersController : BaseController, ITransfersController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransfersController"/> class.
        /// </summary>
        public TransfersController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
